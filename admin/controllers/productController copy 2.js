...
const addProduct = async (req, res) => {
  const { name, catId, subCatId, brandId, images, varients, details } = req.body;
  ...
  if (!varients || varients.length === 0 || !varients[0].units || !varients[0].stock || !varients[0].mrp || !varients[0].sellingPrice) {
